...
public abstract class BaseModule implements CommandLineRunner {
	...
	public static void run(Class<? extends BaseModule> module, String batchName, String[] args) throws IOException {
...
//		{db.mybatis.r.typeAliasesPackage=com.cml.learning.module.bat00X.beans,com.bolstra.beans,
// db.mybatis.rw.typeAliasesPackage=com.cml.learning.module.bat00X.beans,com.bolstra.beans,
// batchProperties=classpath:config/module/bat00X.properties}
		app.run(args);
//		System.in.read();
	}
